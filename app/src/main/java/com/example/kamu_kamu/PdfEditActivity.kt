...
import com.example.kamu_kamu.databinding.ActivityPdfEditBinding
...
class PdfEditActivity : AppCompatActivity() {
    ...
    // recipeid get from intent started from adapterPdfAdmin
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //get recipe Id to edit recipe info
        ...
        ref.child(recipeId)
            .addListenerForSingleValueEvent(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    //load recipe category info using categoryId
    ...
    private fun updatePdf() {
        Log.d(TAG, "updatePdf: Starting updating recipes info... ")
    ...
    private fun categoryDialog() {
        //show dialog to pick the category of pdf/recipe
        ...
        builder.setTitle("Choose Category")
            .setItems(categoriesArray){dialog, position ->
                // handle click, save category id and title
    ...
    private fun loadCategories() {
        ...
        ref.addListenerForSingleValueEvent(object: ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                //clear list before satarting adding data into them
